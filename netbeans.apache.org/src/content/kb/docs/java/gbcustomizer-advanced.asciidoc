...
* Part 1: link:https://github.com/garawaa/netbeans-website/blob/master/netbeans.apache.org/src/content/kb/docs/java/gbcustomizer-basic.asciidoc[+Designing a Basic Java Form Using the GridBag Customizer+]
...
|link:https://github.com/garawaa/netbeans-website/raw/master/netbeans.apache.org/src/content/kb/docs/java/gbcustomizer-advanced-tutorial.zip[+gbcustomizer-advanced-tutorial.zip+] |An archive with the demo project containing the initial and target tutorial layouts. 
|===
...
Before starting to lay out the components with the help of the GridBag Customizer, download the link:https://github.com/garawaa/netbeans-website/raw/master/netbeans.apache.org/src/content/kb/docs/java/gbcustomizer-advanced-tutorial.zip[+gbcustomizer-advanced-tutorial.zip+], extract the  ``GridBagCustomizerAdvancedTutorial``  project on your hard drive and open it in the NetBeans IDE.
