...
* Part 2: link:gbcustomizer-advanced.asciidoc[+Designing an Advanced Java Form Using the GridBag Customizer+]
...
|link:https://github.com/garawaa/netbeans-website/raw/master/netbeans.apache.org/src/content/kb/docs/java/gbcustomizer-basic-tutorial.zip[+gbcustomizer-basic-tutorial.zip+] |An archive with the demo project containing the initial and target tutorial layouts. 
|===
...
1. Download and unzip the link:https://github.com/garawaa/netbeans-website/raw/master/netbeans.apache.org/src/content/kb/docs/java/gbcustomizer-basic-tutorial.zip[+gbcustomizer-basic-tutorial.zip+] project to any location on your computer.
