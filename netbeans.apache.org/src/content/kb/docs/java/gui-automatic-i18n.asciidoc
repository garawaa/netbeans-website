...
1. Download and unzip the link:https://github.com/garawaa/netbeans-website/raw/master/netbeans.apache.org/src/content/kb/docs/java/InternationalizeDemo.zip[+InternationalizeDemo.zip+] project to any location on your computer.
