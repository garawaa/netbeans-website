...
|link:https://github.com/garawaa/netbeans-website/raw/master/netbeans.apache.org/src/content/kb/docs/java/gbcustomizer-basic-tutorial.zip] |An archive with the demo project containing the initial and target tutorial layouts. 
|===
